...
{% include warning.html title="Notice" content="The tested wearable device for the pilot project is the Galaxy Watch 5. Documentation for v1.0 official release is currently under construction. In the meantime, check out release note v1.0 for new features." %}
